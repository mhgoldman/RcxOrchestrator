...
This proof-of-concept Rails app works with the RCX Agent to execute batches of commands on those agents and collate the output and return codes of those commands. 
